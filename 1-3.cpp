...
int main(void) {
	...
	for (int i = 1; i < 501; i++) {
		...
		else if (1.0 / 6.0 < U && U < 2.0 / 6.0) {
			x2 += 1.0;
		}
		else if (2.0 / 6.0 < U && U < 3.0 / 6.0) {
			x3 += 1.0;
		}
		else if (3.0 / 6.0 < U && U < 4.0 / 6.0) {
			x4 += 1.0;
		}
		else if (4.0 / 6.0 < U && U < 5.0 / 6.0) {
			x5 += 1.0;
		}
		else {
			x6 += 1.0;
	...
	ave5 = x5 / 500.0;
	ave6 = x6 / 500.0;
	double ans2 = (ave1 * 1) + (ave2 * 2) + (ave3 * 3) + (ave4 * 4) + (ave5 * 5) + (ave6 * 6); //最終的な期待値)(平均値)
